...
4. 👑 **Менеджер и Админ (Manager, Admin):** Полное управление проектами, назначение команд (мультиселект студентов), смена статусов заказов (от "Created" до "Done"), управление пользователями.
