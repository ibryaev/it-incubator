      ...
      <section className="flex-1 flex flex-col items-center justify-center px-6 pt-20 pb-20">
        <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="w-full max-w-lg space-y-10 relative z-10">
          ...
          <motion.div variants={fadeInUp} className="space-y-4">
            ...
            <GlassInput type="text" placeholder="Тип продукта" value={productType} onChange={e => setProductType(e.target.value)} />
            <GlassInput type="text" placeholder="Ориентировочный бюджет" value={budget} onChange={e => setBudget(e.target.value)} />
            <textarea
